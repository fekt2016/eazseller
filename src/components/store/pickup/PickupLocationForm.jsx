...
const Input = styled.input`
  width: 100%;
  padding: 1rem 1rem;
  border: 1px solid ${props => props.$hasError ? '#A32D2D' : '#E5E7EB'};
  border-radius: 9px;
  font-size: 0.9rem;
  ...
  &:focus {
    outline: none;
    border-color: ${props => props.$hasError ? '#A32D2D' : '#E8920A'};
    box-shadow: 0 0 0 3px ${props => props.$hasError ? '#A32D2D' : '#E8920A'};
  }
